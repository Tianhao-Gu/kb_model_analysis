...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_model_analysis'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_model_analysis.kb_model_analysisImpl import kb_model_analysis  # noqa @IgnorePep8
impl_kb_model_analysis = kb_model_analysis(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_model_analysis'
